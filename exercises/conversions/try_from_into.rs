...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    // * This code tries to cast each color into u8 (0-255) or returns
    // * AND propagates the error
    // * Notice how the struct is returned
    // let (r, g, b) = tuple;
...
impl TryFrom<[i16; 3]> for Color {
    ...
    // * Here's a much more concise implementation
    // * we just use the tuple implementation
    // * since it returns the same Ok and Err
    // * Notice how the array is desctructured
    // let [r, g, b] = arr;
    // (r, g, b).try_into()
}
...
impl TryFrom<&[i16]> for Color {
    ...
    // * Yet another version
    // * The slice is converted into a tuple, but if we can't destructure it
    // * into three items, we return a different error
    // match slice {
